...
class Rook(Piece):
    '''Class representing a Rook piece in chess game'''

    def __init__(self, color, coordinates):
        offsets = [(1, 0), (-1, 0), (0, 1), (0, -1)]
        unicode = u'♖' if color == 'W' else u'♜'
        Piece.__init__(self, coordinates, unicode,'R', color, offsets)

        self.moved = False

    def legal_moves(self, board):
        '''Generates all legal moves for a Rook piece in chess game'''
